...
class AnalysisTest {
    ...
    fun testHaversine() {
        ...
        assertEquals(13.95, distance, 0.5, "Errore nel calcolo della distanza")
    }
    ...
    fun testWaypointsOutsideGeofence() {
        ...
        val waypoints = listOf(
            Waypoint(1, 45.0, 7.0),  // Dentro la geofence
            Waypoint(2, 46.0, 8.0)   // Verifichiamo se è davvero fuori
        )
